        ...
        <div class="col-md-12 col-12">
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" method="POST" action="{{ route('tag-article.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control" name="tag"
                                    ...
                                    <div class="col-12 d-flex gap-2 mt-4 justify-content-start">
                                        ...
                                        <a href="{{ route('tag-article.index') }}"
